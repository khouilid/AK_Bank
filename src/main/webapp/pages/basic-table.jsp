                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <%
                          Users<Personne> personnes = (Users<Personne>) request.getAttribute("Users");
                          ArrayList<Personne> personnes1 = personnes.getUsers();


                          for (int i = 0; i < personnes1.size() ; i++) {

                         %>


                        <tr>
                          <td><% personnes1.get(i).getFirt_name();  %></td>
                          <td><%personnes1.get(i).getSold();%></td>
                          <td>12 May 2017</td>
                          <td><div>
